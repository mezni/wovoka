...
func TestNewLocation_Valid(t *testing.T) {
	loc, err := entities.NewLocation(1, entities.NetworkType2G, "nord", 30.0, 31.0, 7.0, 8.0)
	assert.Nil(t, err)
	assert.NotNil(t, loc)
