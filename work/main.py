...
from src.interactor.usecases.provider_usecase import ProviderUseCase
...
#    payload = {"provider_code": uuid.uuid4(), "provider_name": "Azure"}
#    ret = await provider_repo.add_provider(payload)
#    print(ret)

    provider_usecase = ProviderUseCase(provider_repo)
    xxx=await provider_usecase.execute("Oci")
    print (xxx)
